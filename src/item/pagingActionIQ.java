...
public class pagingActionIQ {
	...
	public pagingActionIQ(int currentPage, int totalCount, int blockCount, int blockPage, int no)
	{
		...
		if (currentPage > blockPage) {
			...
			pagingHtml.append("<a href=SelectItem.action?no="+no+"&currentPage="
					+ (startPage - 1) + ">");
