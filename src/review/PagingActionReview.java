...
public class PagingActionReview {
	...
	public PagingActionReview(int currentPage, int totalCount, int blockCount, int blockPage)
	{
		...
		if (currentPage > blockPage) {
			pagingHtml.append("<a href=ListReview.action?currentPage="
					+ (startPage - 1) + ">");
