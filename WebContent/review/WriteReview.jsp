...
<jsp:include page="../item/SideBar.jsp" flush="false" />
	...
	<div id="subWrap">
		<!-- 콘텐츠부분 -->
			...
			<form action="WriteReview.action" method="post" name="questionwrite" enctype="multipart/form-data" onsubmit="return validation();">
			<s:hidden name="id" value="%{#session.id}"/>
				<div class="writeWrap" id="writeWrap">
					<table>
						...
						<tbody>
							...
							<tr>
								<td colspan="2"><textarea rows="25" cols="62" name="content" style="margin: 0px; width: 1052px; height: 350px;"></textarea></textarea></td>
				...
				<p class="warningDesc">* 공개된 게시판으로 주민번호, 전화번호, 이메일 주소 등 고객님의 소중한 개인정보를 절대 남기지 마세요.</p>
