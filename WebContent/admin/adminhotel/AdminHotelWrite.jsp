	...
	<div id="wrap">
		...
		<div id="subWrap">
			...
			<div class="contents">
				...
				<h2 class="titleSt02">호텔 상품 등록</h2>


				<!-- writeWrap -->
				<div class="formtag">

					<s:form action="AdminHotelWrite" method="POST" name="form"
						...
						<tr>
							<td><br/><br/><th>인원</th>
							<s:textfield name="people" value="10" cssStyle="height:35px; width:150px;" /></td>
						</tr>
						<tr>
						</tr>
						<tr>
							<td><br/><br/><th>객실</th>
							<s:textfield name="room" value="10" cssStyle="height:35px; width:150px;" /></td>
						</tr>
						<tr>
						</tr>
						<tr>
							<td><br/><br/><th>전화번호</th>
							<s:textfield name="tel" cssStyle="height:35px; width:150px;" /></td>
						</tr>
						<tr>
						</tr>
						<tr>
