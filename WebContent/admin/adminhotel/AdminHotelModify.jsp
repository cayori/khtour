	...
	<div id="wrap">
		...
		<div id="subWrap">
			...
			<div class="contents">
				...
				<h2 class="titleSt02">호텔 상품 수정</h2>


				<!-- writeWrap -->
				<div class="formtag">

					<s:form action="ModifyHotel" method="POST"
						enctype="multipart/form-data">
						<s:hidden name="no" value="%{hvo.no}"/>
						<s:hidden name="readcount" value="%{hvo.readcount}"/>
						<s:hidden name="amount" value="%{hvo.amount}"/>
						<s:hidden name="grade" value="%{hvo.grade}"/>
						<s:hidden name="cocount" value="%{hvo.cocount}"/>
						<tr><td><br/><br/><th>제목</th>
							<s:textfield name="name" value="%{hvo.name}" cssStyle="height:35px; width:400px;"/></td>
						</tr>
						<tr>
						</tr>
						<tr><td><br/><br/><th>인원</th>
							<s:textfield name="people" value="%{hvo.people}" cssStyle="height:35px; width:150px;"/></td>
						</tr>
						<tr>
						</tr>
						<tr><td><br/><br/><th>객실</th>
							<s:textfield name="room" value="%{hvo.room}" cssStyle="height:35px; width:150px;"/></td>
						</tr>
						<tr>
						</tr>
						<tr>
							<td><br/><br/><th>전화번호</th>
							<s:textfield name="tel" value="%{hvo.tel}" cssStyle="height:35px; width:150px;" /></td>
						</tr>
						<tr>
						</tr>
						<tr><td><br/><br/><th>국가</th>
							<s:textfield name="country" value="%{hvo.country}" cssStyle="height:35px; width:400px;"/></td>
						</tr>
						<tr>
						</tr>
						<tr><td><br/><br/><th>지역</th>
							<s:textfield name="region" value="%{hvo.region}" cssStyle="height:35px; width:400px;"/></td>
						</tr>
						<tr>
						</tr>
						<tr><td><br/><br/><th>가격</th>
							<s:textfield name="price" value="%{hvo.price}" cssStyle="height:35px; width:150px;"/></td>
						</tr>
						<tr>
						</tr>
						<tr><td><br/><br/><th>상품소개</th>
							<s:textfield name="content" value="%{hvo.content}" cssStyle="height:120px; width:400px;"/></td>
						</tr>
						<br/>
						<tr>
						</tr>
						...
						<tr>
							<td colspan="2"><input type="submit" value="등록"/> <input type="reset"
								...
								value="취소"
								onclick="javascript:location.href='ListHotel.action'" /></td>
						</tr>
					</s:form>
				</div>
