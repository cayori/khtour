	...
	<div id="wrap">
		...
		<div id="subWrap">
			...
			<div class="contents">
				...
				<h2 class="titleSt02">항공 상품 수정</h2>


				<!-- writeWrap -->
				<div class="formtag">

					<s:form action="ModifyAir" method="POST"
						enctype="multipart/form-data">
						<s:hidden name="no" value="%{avo.no}" />
						<s:hidden name="readcount" value="%{avo.readcount}" />
						<s:hidden name="amount" value="%{avo.amount}" />
						<s:hidden name="grade" value="%{avo.grade}" />
						<s:hidden name="cocount" value="%{avo.cocount}" />
					    <tr><td><br/><br/>
							<th>제목</th>
							<s:textfield name="name" value="%{avo.name}"
									cssStyle="height:35px; width:400px;" /></td>
						</tr>
						<tr>
						</tr>
						<tr><td><br/><br/>
							<th>항공</th>
							<s:textfield name="air" value="%{avo.air}"
									cssStyle="height:35px; width:150px;" /></td>
						</tr>
						<tr>
						</tr>
						<tr><td><br/><br/>
							<th>국가</th>
							<s:textfield name="country" value="%{avo.country}"
									cssStyle="height:35px; width:400px;" /></td>
						</tr>
						<tr>
						</tr>
						<tr><td><br/><br/>
							<th>지역</th>
							<s:textfield name="region" value="%{avo.region}"
									cssStyle="height:35px; width:400px;" /></td>
						</tr>
						<tr>
						</tr>
						<tr><td><br/><br/>
							<th>가격
									...
									<s:textfield name="price" value="%{avo.price}"
											cssStyle="height:35px; width:150px;" /></td>
						</tr>
						<tr>
						</tr>
						<tr><td><br/><br/>
							<th>상품소개
									...
									<s:textfield name="content" value="%{avo.content}"
											cssStyle="height:120px; width:400px;" /></td>
						</tr>
						<br />
						<tr>
						</tr>
						...
						<tr>
							<td colspan="2"><input type="submit" value="등록"
								...
								onclick="javascript:location.href='ListAir.action'" /></td>
						</tr>
					</s:form>
				</div>
