...
<body>
	...
	<div id="subWrap">
		...
		<!-- 콘텐츠부분 -->
		<div class="contents">
			<h2 class="titleSt02">공지사항 수정폼</h2>
			<br>
			<br>
			<form action="AdminModifyNotice.action" method="post"
				name="noticemodify" enctype="multipart/form-data"
				...
				<div class="writeWrap" id="writeWrap">
					<table>
						...
						<tbody>
							<tr>
								<s:hidden name="notice_no" value="%{notice_no}" />
								<s:hidden name="currentPage" value="%{currentPage}" />
								<th scope="row"><label for="title">제목</label></th>
								<td><input type="text" id="title" name="subject"
									class="title"
									value="<s:property value='resultClass.subject' />"></td>
							</tr>
							<tr>
								<td colspan="2"><textarea rows="25" cols="62"
										name="content"><s:property
											value="resultClass.content" /></textarea></td>
							</tr>
						</tbody>
					</table>
				</div>
				<div class="btnWrap C" align="right">
					<button type="submit" data="submit" formdata="save"
						class="btn orange" onsubmit="return validation();">등록</button>
				</div>
			</form>
		</div>
		<!-- //콘텐츠부분 -->
